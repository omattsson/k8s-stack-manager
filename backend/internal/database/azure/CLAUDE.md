...
- `models.Repository` (generic) accepts `context.Context`; domain-specific repository interfaces do not accept context — implementations use `context.Background()` internally
