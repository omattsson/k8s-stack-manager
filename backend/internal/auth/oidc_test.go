...
func TestExchange(t *testing.T) {
	...
	assert.Equal(t, "OIDC User", user.Name, "name claim takes priority for display name")
	assert.Equal(t, "oidcuser", user.PreferredUsername, "preferred_username carried separately")
